      ...
      for organization in try(domain.organizations, []) : [
        for network in try(organization.networks, []) : [
          for device in try(network.devices, []) : {
            ...
            wan1_using_static_ip    = try(device.management_interface.wan1.using_static_ip, device.management_interface.lan_ip.using_static_ip, local.defaults.meraki.domains.organizations.networks.devices.management_interface.wan1.using_static_ip, local.defaults.meraki.domains.organizations.networks.devices.management_interface.lan_ip.using_static_ip, null)
            wan1_static_ip          = try(device.management_interface.wan1.static_ip, device.management_interface.lan_ip.static_ip, local.defaults.meraki.domains.organizations.networks.devices.management_interface.wan1.static_ip, local.defaults.meraki.domains.organizations.networks.devices.management_interface.lan_ip.static_ip, null)
            wan1_static_gateway_ip  = try(device.management_interface.wan1.static_gateway_ip, device.management_interface.lan_ip.static_gateway_ip, local.defaults.meraki.domains.organizations.networks.devices.management_interface.wan1.static_gateway_ip, local.defaults.meraki.domains.organizations.networks.devices.management_interface.lan_ip.static_gateway_ip, null)
            wan1_static_subnet_mask = try(device.management_interface.wan1.static_subnet_mask, device.management_interface.lan_ip.static_subnet_mask, local.defaults.meraki.domains.organizations.networks.devices.management_interface.wan1.static_subnet_mask, local.defaults.meraki.domains.organizations.networks.devices.management_interface.lan_ip.static_subnet_mask, null)
            wan1_static_dns         = try(device.management_interface.wan1.static_dns, device.management_interface.lan_ip.static_dns, local.defaults.meraki.domains.organizations.networks.devices.management_interface.wan1.static_dns, local.defaults.meraki.domains.organizations.networks.devices.management_interface.lan_ip.static_dns, null)
            wan1_vlan               = try(device.management_interface.wan1.vlan, device.management_interface.lan_ip.vlan, local.defaults.meraki.domains.organizations.networks.devices.management_interface.wan1.vlan, local.defaults.meraki.domains.organizations.networks.devices.management_interface.lan_ip.vlan, null)
