...
resource "meraki_switch_port" "devices_switch_port" {
  ...
  poe_enabled                 = try(each.value.data.poe, local.defaults.meraki.networks.networks.switch.port_schedules, local.defaults.meraki.networks.devices_switch_ports.poelocal.defaults.meraki.networks.networks.switch.port_schedules, null)
...
resource "meraki_switch_routing_interface" "devices_switch_routing_interface" {
  ...
  ospf_settings_is_passive_enabled = try(each.value.data.ospf_settings.is_passivelocal.defaults.meraki.networks.networks.switch.port_schedules, local.defaults.meraki.networks.devices_switch_routing_interfaces.ospf_settings.is_passivelocal.defaults.meraki.networks.networks.switch.port_schedules, null)
...
resource "meraki_switch_routing_static_route" "devices_switch_routing_static_routes" {
  ...
  advertise_via_ospf_enabled      = try(each.value.data.advertise_via_ospflocal.defaults.meraki.networks.networks.switch.port_schedules, local.defaults.meraki.networks.devices_switch_routing_static_routes.advertise_via_ospflocal.defaults.meraki.networks.networks.switch.port_schedules, null)
  prefer_over_ospf_routes_enabled = try(each.value.data.prefer_over_ospf_routeslocal.defaults.meraki.networks.networks.switch.port_schedules, local.defaults.meraki.networks.devices_switch_routing_static_routes.prefer_over_ospf_routeslocal.defaults.meraki.networks.networks.switch.port_schedules, null)
  depends_on                      = [meraki_switch_routing_interface.devices_switch_routing_interface]
