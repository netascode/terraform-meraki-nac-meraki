        ...
        for network in try(organization.networks, []) : {
          ...
          rules = [
            for switch_access_control_lists_rule in try(network.switch.access_control_lists_rules, []) : {
              comment    = try(switch_access_control_lists_rule.comment, local.defaults.meraki.networks.switch.access_control_lists_rules.comment, null)
              policy     = try(switch_access_control_lists_rule.policy, local.defaults.meraki.networks.switch.access_control_lists_rules.policy, null)
              ip_version = try(switch_access_control_lists_rule.ip_version, local.defaults.meraki.networks.switch.access_control_lists_rules.ip_version, null)
              protocol   = try(switch_access_control_lists_rule.protocol, local.defaults.meraki.networks.switch.access_control_lists_rules.protocol, null)
              src_cidr   = try(switch_access_control_lists_rule.source_cidr, local.defaults.meraki.networks.switch.access_control_lists_rules.source_cidr, null)
              src_port   = try(switch_access_control_lists_rule.source_port, local.defaults.meraki.networks.switch.access_control_lists_rules.source_port, null)
              dst_cidr   = try(switch_access_control_lists_rule.destination_cidr, local.defaults.meraki.networks.switch.access_control_lists_rules.destination_cidr, null)
              dst_port   = try(switch_access_control_lists_rule.destination_port, local.defaults.meraki.networks.switch.access_control_lists_rules.destination_port, null)
              vlan       = try(switch_access_control_lists_rule.vlan, local.defaults.meraki.networks.switch.access_control_lists_rules.vlan, null)
            }
          ]
      ...
      for organization in try(domain.organizations, []) : [
        for network in try(organization.networks, []) : [
          for switch_access_policy in try(network.switch.access_policies, []) : {
            ...
            network_id = meraki_network.network[format("%s/%s/%s", domain.name, organization.name, network.name)].id
            name       = try(switch_access_policy.name, local.defaults.meraki.networks.switch.access_policies.name, null)
            radius_servers = [
              for radius_server in try(switch_access_policy.radius_servers, []) : {
                # TODO Map from organization_radius_server_name.
                organization_radius_server_id = try(radius_server.organization_radius_server_id, local.defaults.meraki.networks.switch.access_policies.radius_servers.organization_radius_server_id, null)
                host                          = try(radius_server.host, local.defaults.meraki.networks.switch.access_policies.radius_servers.host, null)
                port                          = try(radius_server.port, local.defaults.meraki.networks.switch.access_policies.radius_servers.port, null)
                secret                        = try(radius_server.secret, local.defaults.meraki.networks.switch.access_policies.radius_servers.secret, null)
              }
            ]
            radius_critical_auth_data_vlan_id        = try(switch_access_policy.radius.critical_auth.data_vlan_id, local.defaults.meraki.networks.switch.access_policies.radius.critical_auth.data_vlan_id, null)
            radius_critical_auth_voice_vlan_id       = try(switch_access_policy.radius.critical_auth.voice_vlan_id, local.defaults.meraki.networks.switch.access_policies.radius.critical_auth.voice_vlan_id, null)
            radius_critical_auth_suspend_port_bounce = try(switch_access_policy.radius.critical_auth.suspend_port_bounce, local.defaults.meraki.networks.switch.access_policies.radius.critical_auth.suspend_port_bounce, null)
            radius_failed_auth_vlan_id               = try(switch_access_policy.radius.failed_auth_vlan_id, local.defaults.meraki.networks.switch.access_policies.radius.failed_auth_vlan_id, null)
            radius_re_authentication_interval        = try(switch_access_policy.radius.re_authentication_interval, local.defaults.meraki.networks.switch.access_policies.radius.re_authentication_interval, null)
            radius_cache_enabled                     = try(switch_access_policy.radius.cache.enabled, local.defaults.meraki.networks.switch.access_policies.radius.cache.enabled, null)
            radius_cache_timeout                     = try(switch_access_policy.radius.cache.timeout, local.defaults.meraki.networks.switch.access_policies.radius.cache.timeout, null)
            guest_port_bouncing                      = try(switch_access_policy.guest_port_bouncing, local.defaults.meraki.networks.switch.access_policies.guest_port_bouncing, null)
            radius_testing_enabled                   = try(switch_access_policy.radius_testing, local.defaults.meraki.networks.switch.access_policies.radius_testing, null)
            radius_coa_support_enabled               = try(switch_access_policy.radius_coa_support, local.defaults.meraki.networks.switch.access_policies.radius_coa_support, null)
            radius_accounting_enabled                = try(switch_access_policy.radius_accounting, local.defaults.meraki.networks.switch.access_policies.radius_accounting, null)
            radius_accounting_servers = try(length(switch_access_policy.radius_accounting_servers) == 0, true) ? null : [
              for radius_accounting_server in try(switch_access_policy.radius_accounting_servers, []) : {
                # TODO Map from organization_radius_server_name.
                organization_radius_server_id = try(radius_accounting_server.organization_radius_server_id, local.defaults.meraki.networks.switch.access_policies.radius_accounting_servers.organization_radius_server_id, null)
                host                          = try(radius_accounting_server.host, local.defaults.meraki.networks.switch.access_policies.radius_accounting_servers.host, null)
                port                          = try(radius_accounting_server.port, local.defaults.meraki.networks.switch.access_policies.radius_accounting_servers.port, null)
                secret                        = try(radius_accounting_server.secret, local.defaults.meraki.networks.switch.access_policies.radius_accounting_servers.secret, null)
              }
            ]
            radius_group_attribute             = try(switch_access_policy.radius_group_attribute, local.defaults.meraki.networks.switch.access_policies.radius_group_attribute, null)
            host_mode                          = try(switch_access_policy.host_mode, local.defaults.meraki.networks.switch.access_policies.host_mode, null)
            access_policy_type                 = try(switch_access_policy.access_policy_type, local.defaults.meraki.networks.switch.access_policies.access_policy_type, null)
            increase_access_speed              = try(switch_access_policy.increase_access_speed, local.defaults.meraki.networks.switch.access_policies.increase_access_speed, null)
            guest_vlan_id                      = try(switch_access_policy.guest_vlan_id, local.defaults.meraki.networks.switch.access_policies.guest_vlan_id, null)
            dot1x_control_direction            = try(switch_access_policy.dot1x_control_direction, local.defaults.meraki.networks.switch.access_policies.dot1x_control_direction, null)
            voice_vlan_clients                 = try(switch_access_policy.voice_vlan_clients, local.defaults.meraki.networks.switch.access_policies.voice_vlan_clients, null)
            url_redirect_walled_garden_enabled = try(switch_access_policy.url_redirect_walled_garden, local.defaults.meraki.networks.switch.access_policies.url_redirect_walled_garden, null)
            url_redirect_walled_garden_ranges  = try(switch_access_policy.url_redirect_walled_garden_ranges, local.defaults.meraki.networks.switch.access_policies.url_redirect_walled_garden_ranges, null)
          }
        ]
      ]
    ]
    ...
    for domain in try(local.meraki.domains, []) : [
      for organization in try(domain.organizations, []) : [
        for network in try(organization.networks, []) : {
          key        = format("%s/%s/%s", domain.name, organization.name, network.name)
          network_id = meraki_network.network[format("%s/%s/%s", domain.name, organization.name, network.name)].id
          enabled    = try(network.switch.alternate_management_interface.enabled, local.defaults.meraki.networks.switch.alternate_management_interface.enabled, null)
          vlan_id    = try(network.switch.alternate_management_interface.vlan_id, local.defaults.meraki.networks.switch.alternate_management_interface.vlan_id, null)
    ...
    for domain in try(local.meraki.domains, []) : [
      for organization in try(domain.organizations, []) : [
        for network in try(organization.networks, []) : {
          key                    = format("%s/%s/%s", domain.name, organization.name, network.name)
          network_id             = meraki_network.network[format("%s/%s/%s", domain.name, organization.name, network.name)].id
          alerts_email_enabled   = try(network.switch.dhcp_server_policy.alerts_email, local.defaults.meraki.networks.switch.dhcp_server_policy.alerts_email, null)
          default_policy         = try(network.switch.dhcp_server_policy.default_policy, local.defaults.meraki.networks.switch.dhcp_server_policy.default_policy, null)
          allowed_servers        = try(network.switch.dhcp_server_policy.allowed_servers, local.defaults.meraki.networks.switch.dhcp_server_policy.allowed_servers, null)
          blocked_servers        = try(network.switch.dhcp_server_policy.blocked_servers, local.defaults.meraki.networks.switch.dhcp_server_policy.blocked_servers, null)
          arp_inspection_enabled = try(network.switch.dhcp_server_policy.arp_inspection, local.defaults.meraki.networks.switch.dhcp_server_policy.arp_inspection, null)
      ...
      for organization in try(domain.organizations, []) : [
        for network in try(organization.networks, []) : [
          for switch_dhcp_server_policy_arp_inspection_trusted_server in try(network.switch.dhcp_server_policy.arp_inspection_trusted_servers, []) : {
            ...
            ipv4_address = try(switch_dhcp_server_policy_arp_inspection_trusted_server.ipv4_address, local.defaults.meraki.networks.switch.dhcp_server_policy.arp_inspection_trusted_servers.ipv4_address, null)
          }
        ]
      ]
    ]
        ...
        for network in try(organization.networks, []) : {
          ...
          mappings = [
            for switch_dscp_to_cos_mapping in try(network.switch.dscp_to_cos_mappings, []) : {
              dscp  = try(switch_dscp_to_cos_mapping.dscp, local.defaults.meraki.networks.switch.dscp_to_cos_mappings.dscp, null)
              cos   = try(switch_dscp_to_cos_mapping.cos, local.defaults.meraki.networks.switch.dscp_to_cos_mappings.cos, null)
              title = try(switch_dscp_to_cos_mapping.title, local.defaults.meraki.networks.switch.dscp_to_cos_mappings.title, null)
            }
          ]
          ...
          for switch_link_aggregation in try(network.switch.link_aggregations, []) : {
            ...
            switch_profile_ports = try(length(switch_link_aggregation.switch_profile_ports) == 0, true) ? null : [
              for switch_profile_port in try(switch_link_aggregation.switch_profile_ports, []) : {
                profile = try(switch_profile_port.profile, local.defaults.meraki.networks.switch.link_aggregations.switch_profile_ports.profile, null)
                port_id = try(switch_profile_port.port_id, local.defaults.meraki.networks.switch.link_aggregations.switch_profile_ports.port_id, null)
              }
            ]
          }
        ]
    ...
    for domain in try(local.meraki.domains, []) : [
      for organization in try(domain.organizations, []) : [
        for network in try(organization.networks, []) : {
          key              = format("%s/%s/%s", domain.name, organization.name, network.name)
          network_id       = meraki_network.network[format("%s/%s/%s", domain.name, organization.name, network.name)].id
          default_mtu_size = try(network.switch.mtu.default_mtu_size, local.defaults.meraki.networks.switch.mtu.default_mtu_size, null)
          overrides = try(length(network.switch.mtu.overrides) == 0, true) ? null : [
            for override in try(network.switch.mtu.overrides, []) : {
              ...
              switches        = try(override.switches, local.defaults.meraki.networks.switch.mtu.overrides.switches, null)
              switch_profiles = try(override.switch_profiles, local.defaults.meraki.networks.switch.mtu.overrides.switch_profiles, null)
              mtu_size        = try(override.mtu_size, local.defaults.meraki.networks.switch.mtu.overrides.mtu_size, null)
            }
          ]
      ...
      for organization in try(domain.organizations, []) : [
        for network in try(organization.networks, []) : [
          for switch_port_schedule in try(network.switch.port_schedules, []) : {
            ...
            network_id                     = meraki_network.network[format("%s/%s/%s", domain.name, organization.name, network.name)].id
            name                           = try(switch_port_schedule.name, local.defaults.meraki.networks.switch.port_schedules.name, null)
            port_schedule_monday_active    = try(switch_port_schedule.port_schedule.monday.active, local.defaults.meraki.networks.switch.port_schedules.port_schedule.monday.active, null)
            port_schedule_monday_from      = try(switch_port_schedule.port_schedule.monday.from, local.defaults.meraki.networks.switch.port_schedules.port_schedule.monday.from, null)
            port_schedule_monday_to        = try(switch_port_schedule.port_schedule.monday.to, local.defaults.meraki.networks.switch.port_schedules.port_schedule.monday.to, null)
            port_schedule_tuesday_active   = try(switch_port_schedule.port_schedule.tuesday.active, local.defaults.meraki.networks.switch.port_schedules.port_schedule.tuesday.active, null)
            port_schedule_tuesday_from     = try(switch_port_schedule.port_schedule.tuesday.from, local.defaults.meraki.networks.switch.port_schedules.port_schedule.tuesday.from, null)
            port_schedule_tuesday_to       = try(switch_port_schedule.port_schedule.tuesday.to, local.defaults.meraki.networks.switch.port_schedules.port_schedule.tuesday.to, null)
            port_schedule_wednesday_active = try(switch_port_schedule.port_schedule.wednesday.active, local.defaults.meraki.networks.switch.port_schedules.port_schedule.wednesday.active, null)
            port_schedule_wednesday_from   = try(switch_port_schedule.port_schedule.wednesday.from, local.defaults.meraki.networks.switch.port_schedules.port_schedule.wednesday.from, null)
            port_schedule_wednesday_to     = try(switch_port_schedule.port_schedule.wednesday.to, local.defaults.meraki.networks.switch.port_schedules.port_schedule.wednesday.to, null)
            port_schedule_thursday_active  = try(switch_port_schedule.port_schedule.thursday.active, local.defaults.meraki.networks.switch.port_schedules.port_schedule.thursday.active, null)
            port_schedule_thursday_from    = try(switch_port_schedule.port_schedule.thursday.from, local.defaults.meraki.networks.switch.port_schedules.port_schedule.thursday.from, null)
            port_schedule_thursday_to      = try(switch_port_schedule.port_schedule.thursday.to, local.defaults.meraki.networks.switch.port_schedules.port_schedule.thursday.to, null)
            port_schedule_friday_active    = try(switch_port_schedule.port_schedule.friday.active, local.defaults.meraki.networks.switch.port_schedules.port_schedule.friday.active, null)
            port_schedule_friday_from      = try(switch_port_schedule.port_schedule.friday.from, local.defaults.meraki.networks.switch.port_schedules.port_schedule.friday.from, null)
            port_schedule_friday_to        = try(switch_port_schedule.port_schedule.friday.to, local.defaults.meraki.networks.switch.port_schedules.port_schedule.friday.to, null)
            port_schedule_saturday_active  = try(switch_port_schedule.port_schedule.saturday.active, local.defaults.meraki.networks.switch.port_schedules.port_schedule.saturday.active, null)
            port_schedule_saturday_from    = try(switch_port_schedule.port_schedule.saturday.from, local.defaults.meraki.networks.switch.port_schedules.port_schedule.saturday.from, null)
            port_schedule_saturday_to      = try(switch_port_schedule.port_schedule.saturday.to, local.defaults.meraki.networks.switch.port_schedules.port_schedule.saturday.to, null)
            port_schedule_sunday_active    = try(switch_port_schedule.port_schedule.sunday.active, local.defaults.meraki.networks.switch.port_schedules.port_schedule.sunday.active, null)
            port_schedule_sunday_from      = try(switch_port_schedule.port_schedule.sunday.from, local.defaults.meraki.networks.switch.port_schedules.port_schedule.sunday.from, null)
            port_schedule_sunday_to        = try(switch_port_schedule.port_schedule.sunday.to, local.defaults.meraki.networks.switch.port_schedules.port_schedule.sunday.to, null)
          }
        ]
      ]
    ]
      ...
      for organization in try(domain.organizations, []) : [
        for network in try(organization.networks, []) : [
          for switch_qos_rule in try(network.switch.qos_rules, []) : {
            ...
            network_id     = meraki_network.network[format("%s/%s/%s", domain.name, organization.name, network.name)].id
            vlan           = try(switch_qos_rule.vlan, local.defaults.meraki.networks.switch.qos_rules.vlan, null)
            protocol       = try(switch_qos_rule.protocol, local.defaults.meraki.networks.switch.qos_rules.protocol, null)
            src_port       = try(switch_qos_rule.source_port, local.defaults.meraki.networks.switch.qos_rules.source_port, null)
            src_port_range = try(switch_qos_rule.source_port_range, local.defaults.meraki.networks.switch.qos_rules.source_port_range, null)
            dst_port       = try(switch_qos_rule.destination_port, local.defaults.meraki.networks.switch.qos_rules.destination_port, null)
            dst_port_range = try(switch_qos_rule.destination_port_range, local.defaults.meraki.networks.switch.qos_rules.destination_port_range, null)
            dscp           = try(switch_qos_rule.dscp, local.defaults.meraki.networks.switch.qos_rules.dscp, null)
          }
        ]
      ]
    ]
    ...
    for domain in try(local.meraki.domains, []) : [
      for organization in try(domain.organizations, []) : [
        for network in try(organization.networks, []) : {
          key                                                      = format("%s/%s/%s", domain.name, organization.name, network.name)
          network_id                                               = meraki_network.network[format("%s/%s/%s", domain.name, organization.name, network.name)].id
          default_settings_igmp_snooping_enabled                   = try(network.switch.routing_multicast.default_settings.igmp_snooping, local.defaults.meraki.networks.switch.routing_multicast.default_settings.igmp_snooping, null)
          default_settings_flood_unknown_multicast_traffic_enabled = try(network.switch.routing_multicast.default_settings.flood_unknown_multicast_traffic, local.defaults.meraki.networks.switch.routing_multicast.default_settings.flood_unknown_multicast_traffic, null)
          overrides = try(length(network.switch.routing_multicast.overrides) == 0, true) ? null : [
            for override in try(network.switch.routing_multicast.overrides, []) : {
              switch_profiles = try(override.switch_profiles, local.defaults.meraki.networks.switch.routing_multicast.overrides.switch_profiles, null)
              # TODO Map from device names to serials?
              switches = try(override.switches, local.defaults.meraki.networks.switch.routing_multicast.overrides.switches, null)
              # TODO Map from stack names to IDs?
              stacks                                  = try(override.stacks, local.defaults.meraki.networks.switch.routing_multicast.overrides.stacks, null)
              igmp_snooping_enabled                   = try(override.igmp_snooping, local.defaults.meraki.networks.switch.routing_multicast.overrides.igmp_snooping, null)
              flood_unknown_multicast_traffic_enabled = try(override.flood_unknown_multicast_traffic, local.defaults.meraki.networks.switch.routing_multicast.overrides.flood_unknown_multicast_traffic, null)
            }
          ]
    ...
    for domain in try(local.meraki.domains, []) : [
      for organization in try(domain.organizations, []) : [
        for network in try(organization.networks, []) : {
          key                    = format("%s/%s/%s", domain.name, organization.name, network.name)
          network_id             = meraki_network.network[format("%s/%s/%s", domain.name, organization.name, network.name)].id
          enabled                = try(network.switch.routing_ospf.enabled, local.defaults.meraki.networks.switch.routing_ospf.enabled, null)
          hello_timer_in_seconds = try(network.switch.routing_ospf.hello_timer_in_seconds, local.defaults.meraki.networks.switch.routing_ospf.hello_timer_in_seconds, null)
          dead_timer_in_seconds  = try(network.switch.routing_ospf.dead_timer_in_seconds, local.defaults.meraki.networks.switch.routing_ospf.dead_timer_in_seconds, null)
          areas = try(length(network.switch.routing_ospf.areas) == 0, true) ? null : [
            for area in try(network.switch.routing_ospf.areas, []) : {
              area_id   = try(area.area_id, local.defaults.meraki.networks.switch.routing_ospf.areas.area_id, null)
              area_name = try(area.area_name, local.defaults.meraki.networks.switch.routing_ospf.areas.area_name, null)
              area_type = try(area.area_type, local.defaults.meraki.networks.switch.routing_ospf.areas.area_type, null)
            }
          ]
          v3_enabled                = try(network.switch.routing_ospf.v3.enabled, local.defaults.meraki.networks.switch.routing_ospf.v3.enabled, null)
          v3_hello_timer_in_seconds = try(network.switch.routing_ospf.v3.hello_timer_in_seconds, local.defaults.meraki.networks.switch.routing_ospf.v3.hello_timer_in_seconds, null)
          v3_dead_timer_in_seconds  = try(network.switch.routing_ospf.v3.dead_timer_in_seconds, local.defaults.meraki.networks.switch.routing_ospf.v3.dead_timer_in_seconds, null)
          v3_areas = try(length(network.switch.routing_ospf.v3.areas) == 0, true) ? null : [
            for v3_area in try(network.switch.routing_ospf.v3.areas, []) : {
              area_id   = try(v3_area.area_id, local.defaults.meraki.networks.switch.routing_ospf.v3.areas.area_id, null)
              area_name = try(v3_area.area_name, local.defaults.meraki.networks.switch.routing_ospf.v3.areas.area_name, null)
              area_type = try(v3_area.area_type, local.defaults.meraki.networks.switch.routing_ospf.v3.areas.area_type, null)
            }
          ]
          md5_authentication_enabled        = try(network.switch.routing_ospf.md5_authentication, local.defaults.meraki.networks.switch.routing_ospf.md5_authentication, null)
          md5_authentication_key_id         = try(network.switch.routing_ospf.md5_authentication_key.id, local.defaults.meraki.networks.switch.routing_ospf.md5_authentication_key.id, null)
          md5_authentication_key_passphrase = try(network.switch.routing_ospf.md5_authentication_key.passphrase, local.defaults.meraki.networks.switch.routing_ospf.md5_authentication_key.passphrase, null)
    ...
    for domain in try(local.meraki.domains, []) : [
      for organization in try(domain.organizations, []) : [
        for network in try(organization.networks, []) : {
          key                = format("%s/%s/%s", domain.name, organization.name, network.name)
          network_id         = meraki_network.network[format("%s/%s/%s", domain.name, organization.name, network.name)].id
          vlan               = try(network.switch.settings.vlan, local.defaults.meraki.networks.switch.settings.vlan, null)
          ...
          uplink_client_sampling_enabled = try(network.switch.settings.uplink_client_sampling, local.defaults.meraki.networks.switch.settings.uplink_client_sampling, null)
          mac_blocklist_enabled          = try(network.switch.settings.mac_blocklist, local.defaults.meraki.networks.switch.settings.mac_blocklist, null)
    ...
    for domain in try(local.meraki.domains, []) : [
      for organization in try(domain.organizations, []) : [
        for network in try(organization.networks, []) : {
          key                                        = format("%s/%s/%s", domain.name, organization.name, network.name)
          network_id                                 = meraki_network.network[format("%s/%s/%s", domain.name, organization.name, network.name)].id
          broadcast_threshold                        = try(network.switch.storm_control.broadcast_threshold, local.defaults.meraki.networks.switch.storm_control.broadcast_threshold, null)
          multicast_threshold                        = try(network.switch.storm_control.multicast_threshold, local.defaults.meraki.networks.switch.storm_control.multicast_threshold, null)
          unknown_unicast_threshold                  = try(network.switch.storm_control.unknown_unicast_threshold, local.defaults.meraki.networks.switch.storm_control.unknown_unicast_threshold, null)
          treat_these_traffic_types_as_one_threshold = try(network.switch.storm_control.treat_these_traffic_types_as_one_threshold, local.defaults.meraki.networks.switch.storm_control.treat_these_traffic_types_as_one_threshold, null)
    ...
    for domain in try(local.meraki.domains, []) : [
      for organization in try(domain.organizations, []) : [
        for network in try(organization.networks, []) : {
          key          = format("%s/%s/%s", domain.name, organization.name, network.name)
          network_id   = meraki_network.network[format("%s/%s/%s", domain.name, organization.name, network.name)].id
          rstp_enabled = try(network.switch.stp.rstp, local.defaults.meraki.networks.switch.stp.rstp, null)
        ...
        for network in try(organization.networks, []) : [
          for switch_stack in try(network.switch_stacks, []) : [
            for routing_interface in try(switch_stack.routing_interfaces, []) : {
              ...
              multicast_routing                = try(routing_interface.multicast_routing, local.defaults.meraki.networks.switch_stacks.routing_interfaces.multicast_routing, null)
              vlan_id                          = try(routing_interface.vlan_id, local.defaults.meraki.networks.switch_stacks.routing_interfaces.vlan_id, null)
              default_gateway                  = try(routing_interface.default_gateway, local.defaults.meraki.networks.switch_stacks.routing_interfaces.default_gateway, null)
              ospf_settings_area               = try(routing_interface.ospf_settings.area, local.defaults.meraki.networks.switch_stacks.routing_interfaces.ospf_settings.area, null)
              ospf_settings_cost               = try(routing_interface.ospf_settings.cost, local.defaults.meraki.networks.switch_stacks.routing_interfaces.ospf_settings.cost, null)
              ospf_settings_is_passive_enabled = try(routing_interface.ospf_settings.is_passive, local.defaults.meraki.networks.switch_stacks.routing_interfaces.ospf_settings.is_passive, null)
              ipv6_assignment_mode             = try(routing_interface.ipv6.assignment_mode, local.defaults.meraki.networks.switch_stacks.routing_interfaces.ipv6.assignment_mode, null)
              ipv6_prefix                      = try(routing_interface.ipv6.prefix, local.defaults.meraki.networks.switch_stacks.routing_interfaces.ipv6.prefix, null)
              ipv6_address                     = try(routing_interface.ipv6.address, local.defaults.meraki.networks.switch_stacks.routing_interfaces.ipv6.address, null)
              ipv6_gateway                     = try(routing_interface.ipv6.gateway, local.defaults.meraki.networks.switch_stacks.routing_interfaces.ipv6.gateway, null)
            }
          ]
        ]
      ]
        ...
        for network in try(organization.networks, []) : [
          for switch_stack in try(network.switch_stacks, []) : [
            for routing_static_route in try(switch_stack.routing_static_routes, []) : {
              ...
              advertise_via_ospf_enabled      = try(routing_static_route.advertise_via_ospf, local.defaults.meraki.networks.switch_stacks.routing_static_routes.advertise_via_ospf, null)
              prefer_over_ospf_routes_enabled = try(routing_static_route.prefer_over_ospf_routes, local.defaults.meraki.networks.switch_stacks.routing_static_routes.prefer_over_ospf_routes, null)
            }
          ]
        ]
      ]
