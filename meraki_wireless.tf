...
resource "meraki_wireless_rf_profile" "net_networks_wireless_rf_profiles" {
  ...
  per_ssid_settings0_min_bitrate = try(each.value.data.per_ssid_settings.0.min_bitrate, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.0.min_bitrate, null)
  per_ssid_settings0_band_operation_mode = try(each.value.data.per_ssid_settings.0.band_operation_mode, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.0.band_operation_mode, null)
  per_ssid_settings0_bands_enabled = try(each.value.data.per_ssid_settings.0.bands.enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.0.bands.enabled, null)
  per_ssid_settings0_band_steering_enabled = try(each.value.data.per_ssid_settings.0.band_steering_enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.0.band_steering_enabled, null)
  per_ssid_settings1_min_bitrate = try(each.value.data.per_ssid_settings.1.min_bitrate, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.1.min_bitrate, null)
  per_ssid_settings1_band_operation_mode = try(each.value.data.per_ssid_settings.1.band_operation_mode, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.1.band_operation_mode, null)
  per_ssid_settings1_bands_enabled = try(each.value.data.per_ssid_settings.1.bands.enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.1.bands.enabled, null)
  per_ssid_settings1_band_steering_enabled = try(each.value.data.per_ssid_settings.1.band_steering_enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.1.band_steering_enabled, null)
  per_ssid_settings2_min_bitrate = try(each.value.data.per_ssid_settings.2.min_bitrate, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.2.min_bitrate, null)
  per_ssid_settings2_band_operation_mode = try(each.value.data.per_ssid_settings.2.band_operation_mode, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.2.band_operation_mode, null)
  per_ssid_settings2_bands_enabled = try(each.value.data.per_ssid_settings.2.bands.enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.2.bands.enabled, null)
  per_ssid_settings2_band_steering_enabled = try(each.value.data.per_ssid_settings.2.band_steering_enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.2.band_steering_enabled, null)
  per_ssid_settings3_min_bitrate = try(each.value.data.per_ssid_settings.3.min_bitrate, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.3.min_bitrate, null)
  per_ssid_settings3_band_operation_mode = try(each.value.data.per_ssid_settings.3.band_operation_mode, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.3.band_operation_mode, null)
  per_ssid_settings3_bands_enabled = try(each.value.data.per_ssid_settings.3.bands.enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.3.bands.enabled, null)
  per_ssid_settings3_band_steering_enabled = try(each.value.data.per_ssid_settings.3.band_steering_enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.3.band_steering_enabled, null)
  per_ssid_settings4_min_bitrate = try(each.value.data.per_ssid_settings.4.min_bitrate, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.4.min_bitrate, null)
  per_ssid_settings4_band_operation_mode = try(each.value.data.per_ssid_settings.4.band_operation_mode, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.4.band_operation_mode, null)
  per_ssid_settings4_bands_enabled = try(each.value.data.per_ssid_settings.4.bands.enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.4.bands.enabled, null)
  per_ssid_settings4_band_steering_enabled = try(each.value.data.per_ssid_settings.4.band_steering_enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.4.band_steering_enabled, null)
  per_ssid_settings5_min_bitrate = try(each.value.data.per_ssid_settings.5.min_bitrate, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.5.min_bitrate, null)
  per_ssid_settings5_band_operation_mode = try(each.value.data.per_ssid_settings.5.band_operation_mode, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.5.band_operation_mode, null)
  per_ssid_settings5_bands_enabled = try(each.value.data.per_ssid_settings.5.bands.enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.5.bands.enabled, null)
  per_ssid_settings5_band_steering_enabled = try(each.value.data.per_ssid_settings.5.band_steering_enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.5.band_steering_enabled, null)
  per_ssid_settings6_min_bitrate = try(each.value.data.per_ssid_settings.6.min_bitrate, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.6.min_bitrate, null)
  per_ssid_settings6_band_operation_mode = try(each.value.data.per_ssid_settings.6.band_operation_mode, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.6.band_operation_mode, null)
  per_ssid_settings6_bands_enabled = try(each.value.data.per_ssid_settings.6.bands.enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.6.bands.enabled, null)
  per_ssid_settings6_band_steering_enabled = try(each.value.data.per_ssid_settings.6.band_steering_enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.6.band_steering_enabled, null)
  per_ssid_settings7_min_bitrate = try(each.value.data.per_ssid_settings.7.min_bitrate, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.7.min_bitrate, null)
  per_ssid_settings7_band_operation_mode = try(each.value.data.per_ssid_settings.7.band_operation_mode, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.7.band_operation_mode, null)
  per_ssid_settings7_bands_enabled = try(each.value.data.per_ssid_settings.7.bands.enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.7.bands.enabled, null)
  per_ssid_settings7_band_steering_enabled = try(each.value.data.per_ssid_settings.7.band_steering_enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.7.band_steering_enabled, null)
  per_ssid_settings8_min_bitrate = try(each.value.data.per_ssid_settings.8.min_bitrate, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.8.min_bitrate, null)
  per_ssid_settings8_band_operation_mode = try(each.value.data.per_ssid_settings.8.band_operation_mode, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.8.band_operation_mode, null)
  per_ssid_settings8_bands_enabled = try(each.value.data.per_ssid_settings.8.bands.enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.8.bands.enabled, null)
  per_ssid_settings8_band_steering_enabled = try(each.value.data.per_ssid_settings.8.band_steering_enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.8.band_steering_enabled, null)
  per_ssid_settings9_min_bitrate = try(each.value.data.per_ssid_settings.9.min_bitrate, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.9.min_bitrate, null)
  per_ssid_settings9_band_operation_mode = try(each.value.data.per_ssid_settings.9.band_operation_mode, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.9.band_operation_mode, null)
  per_ssid_settings9_bands_enabled = try(each.value.data.per_ssid_settings.9.bands.enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.9.bands.enabled, null)
  per_ssid_settings9_band_steering_enabled = try(each.value.data.per_ssid_settings.9.band_steering_enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.9.band_steering_enabled, null)
  per_ssid_settings10_min_bitrate = try(each.value.data.per_ssid_settings.10.min_bitrate, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.10.min_bitrate, null)
  per_ssid_settings10_band_operation_mode = try(each.value.data.per_ssid_settings.10.band_operation_mode, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.10.band_operation_mode, null)
  per_ssid_settings10_bands_enabled = try(each.value.data.per_ssid_settings.10.bands.enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.10.bands.enabled, null)
  per_ssid_settings10_band_steering_enabled = try(each.value.data.per_ssid_settings.10.band_steering_enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.10.band_steering_enabled, null)
  per_ssid_settings11_min_bitrate = try(each.value.data.per_ssid_settings.11.min_bitrate, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.11.min_bitrate, null)
  per_ssid_settings11_band_operation_mode = try(each.value.data.per_ssid_settings.11.band_operation_mode, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.11.band_operation_mode, null)
  per_ssid_settings11_bands_enabled = try(each.value.data.per_ssid_settings.11.bands.enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.11.bands.enabled, null)
  per_ssid_settings11_band_steering_enabled = try(each.value.data.per_ssid_settings.11.band_steering_enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.11.band_steering_enabled, null)
  per_ssid_settings12_min_bitrate = try(each.value.data.per_ssid_settings.12.min_bitrate, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.12.min_bitrate, null)
  per_ssid_settings12_band_operation_mode = try(each.value.data.per_ssid_settings.12.band_operation_mode, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.12.band_operation_mode, null)
  per_ssid_settings12_bands_enabled = try(each.value.data.per_ssid_settings.12.bands.enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.12.bands.enabled, null)
  per_ssid_settings12_band_steering_enabled = try(each.value.data.per_ssid_settings.12.band_steering_enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.12.band_steering_enabled, null)
  per_ssid_settings13_min_bitrate = try(each.value.data.per_ssid_settings.13.min_bitrate, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.13.min_bitrate, null)
  per_ssid_settings13_band_operation_mode = try(each.value.data.per_ssid_settings.13.band_operation_mode, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.13.band_operation_mode, null)
  per_ssid_settings13_bands_enabled = try(each.value.data.per_ssid_settings.13.bands.enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.13.bands.enabled, null)
  per_ssid_settings13_band_steering_enabled = try(each.value.data.per_ssid_settings.13.band_steering_enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.13.band_steering_enabled, null)
  per_ssid_settings14_min_bitrate = try(each.value.data.per_ssid_settings.14.min_bitrate, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.14.min_bitrate, null)
  per_ssid_settings14_band_operation_mode = try(each.value.data.per_ssid_settings.14.band_operation_mode, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.14.band_operation_mode, null)
  per_ssid_settings14_bands_enabled = try(each.value.data.per_ssid_settings.14.bands.enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.14.bands.enabled, null)
  per_ssid_settings14_band_steering_enabled = try(each.value.data.per_ssid_settings.14.band_steering_enabled, local.defaults.meraki.networks.networks_wireless_rf_profiles.per_ssid_settings.14.band_steering_enabled, null)
