...
resource "meraki_wireless_rf_profile" "networks_wireless_rf_profiles" {
  ...
  per_ssid_settings_0_bands_enabled          = try(each.value.per_ssid_settings[0].bands_enabled, null)
  ...
  per_ssid_settings_1_bands_enabled          = try(each.value.per_ssid_settings[1].bands_enabled, null)
  ...
  per_ssid_settings_2_bands_enabled          = try(each.value.per_ssid_settings[2].bands_enabled, null)
  ...
  per_ssid_settings_3_bands_enabled          = try(each.value.per_ssid_settings[3].bands_enabled, null)
  ...
  per_ssid_settings_4_bands_enabled          = try(each.value.per_ssid_settings[4].bands_enabled, null)
  ...
  per_ssid_settings_5_bands_enabled          = try(each.value.per_ssid_settings[5].bands_enabled, null)
  ...
  per_ssid_settings_6_bands_enabled          = try(each.value.per_ssid_settings[6].bands_enabled, null)
  ...
  per_ssid_settings_7_bands_enabled          = try(each.value.per_ssid_settings[7].bands_enabled, null)
  ...
  per_ssid_settings_8_bands_enabled          = try(each.value.per_ssid_settings[8].bands_enabled, null)
  ...
  per_ssid_settings_9_bands_enabled          = try(each.value.per_ssid_settings[9].bands_enabled, null)
  ...
  per_ssid_settings_10_bands_enabled         = try(each.value.per_ssid_settings[10].bands_enabled, null)
  ...
  per_ssid_settings_11_bands_enabled         = try(each.value.per_ssid_settings[11].bands_enabled, null)
  ...
  per_ssid_settings_12_bands_enabled         = try(each.value.per_ssid_settings[12].bands_enabled, null)
  ...
  per_ssid_settings_13_bands_enabled         = try(each.value.per_ssid_settings[13].bands_enabled, null)
  ...
  per_ssid_settings_14_bands_enabled         = try(each.value.per_ssid_settings[14].bands_enabled, null)
      ...
      for organization in try(domain.organizations, []) : [
        for network in try(organization.networks, []) : [
          for wireless_ssid in try(network.wireless.ssids, []) : {
            ...
            sentry_enrollment_systems_manager_network_id  = try(local.organizations_network_ids[format("%s/%s/%s", domain.name, organization.name, wireless_ssid.splash_settings.sentry_enrollment.systems_manager_network)], null)
