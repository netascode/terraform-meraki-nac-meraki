...
resource "meraki_appliance_port" "networks_appliance_ports" {
  ...
  depends_on            = [meraki_network_device_claim.networks_devices_claim_batch_0, meraki_network_device_claim.networks_devices_claim_batch_delayed, meraki_appliance_vlan.networks_appliance_vlans, meraki_appliance_single_lan.networks_appliance_single_lan]
}
...
resource "meraki_appliance_site_to_site_vpn" "networks_appliance_vpn_site_to_site_vpn" {
  ...
  depends_on            = [meraki_network_device_claim.networks_devices_claim_batch_0, meraki_network_device_claim.networks_devices_claim_batch_delayed, meraki_appliance_single_lan.networks_appliance_single_lan, meraki_appliance_vlan.networks_appliance_vlans]
}
